javascript:(function(){
	...
	let pages = document.querySelector('.ndfHFb-c4YZDc-cYSp0e-Oz6c3e.ndfHFb-c4YZDc-cYSp0e-DARUcf-gSKZZ.ndfHFb-c4YZDc-neVct-RCfa3e');
	if(pages.style.filter == "none"){
		pages.style.filter = "invert(1)";
	}else{
		pages.style.filter = "none";
	}
  }
});
